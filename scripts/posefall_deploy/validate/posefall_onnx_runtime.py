...
def parse_args() -> argparse.Namespace:
    ...
    work = project / "exports" / "posefall-hi3516cv610" / "work"
    ...
    parser.add_argument("--pose", default=str(work / "onnx" / "pose_yolo.onnx"), help="Exported YOLO pose ONNX model.")
    parser.add_argument("--head", default=str(work / "onnx" / "posefall_head.onnx"), help="Exported PoseFall head ONNX model.")
    parser.add_argument(
        "--meta", default=str(work / "onnx" / "posefall_export_meta.json"), help="PoseFall export metadata JSON."
    )
    parser.add_argument("--tracker", default=str(work / "tracker" / "fall_botsort.yaml"), help="Ultralytics tracker YAML.")
